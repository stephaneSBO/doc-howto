...
* https://www.jeedom.com/doc/documentation/plugins/jeelink/fr_FR/jeelink[Configuration] dans le plugin "Jeedom Link" du *Jeedom Cible* (Ancien Maître).
...
Sur le *Jeedom Source*, configurer le plugin "Jeedom Link" en spécifiant :
