...
IMPORTANT: Faites bien attention de ne pas faire de boucle d'équipement en configurant le plugin JeeLink. Par exemple ne pas faire un Equiement-X dans un Jeedom1 qui remonte dans un Jeedom2 puis remonte à nouveau dans le Jeedom1. Cela pourrait faire tomber vos Jeedom !
...
- Les notions de *Jeedom Maître* et *Jeedom Esclave* ne sont plus d'actualité. Le nouveau mode de fonctionnement de synchronisation d'équipements entre plusieurs Jeedoms est bidirectionnel (un serveur Jeedom peut être désormais *Source* et *Cible*) alors que l'ancien mode ne permettait que la remontée des équipements de l'esclave vers le maitre. +
  +
