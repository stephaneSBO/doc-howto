...
NOTE: Après avoir bien validé que vos équipements/scénarios/interactions/virtuels/.... fonctionnent bien avec le nouveau système jeelink, vous pouvez procéder au ménage.
